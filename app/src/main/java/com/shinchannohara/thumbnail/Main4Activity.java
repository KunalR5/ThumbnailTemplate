...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText one = (EditText)findViewById(R.id.six);
        final EditText two = (EditText)findViewById(R.id.fashion);
        final EditText three = (EditText)findViewById(R.id.mistake);
        final EditText four = (EditText)findViewById(R.id.making);
        ...
        final ConstraintLayout constraintLayout = (ConstraintLayout)findViewById(R.id.constraintLayout4);
        ...
        one.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                colourbtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        new ColorPickerPopup.Builder(Main4Activity.this).initialColor(Color.RED)
        ...
        four.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                int a = four.getCurrentTextColor();
                colourbtn.setBackgroundColor(a);
                colourbtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
